...
impl Default for ToolbarItemWidget {
    fn default() -> Self {
        Self { position: Vec2::ZERO, size: Vec2::ONE * 100., background_color: Color::GREEN, node: WidgetNode(Option::None), built: false, align_self: AlignSelf::Auto, justify_self: JustifySelf::Auto }
    }
}

#[derive(Bundle)]
pub struct ToolbarItemWidgetBundle {
    pub toolbar_item_widget: ToolbarItemWidget,
}

impl Default for ToolbarItemWidgetBundle {
    fn default() -> Self {
        Self::new()
    }
}

impl Widget for ToolbarItemWidget {
...
impl ToolbarItemWidgetBundle {
    pub fn new() -> Self {
        Self {  toolbar_item_widget: ToolbarItemWidget::default() }
    }
}